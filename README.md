...
- **Piano**: scegli gara, data e corse/settimana → genera un piano completo con ritmi personalizzati, scarico ogni 4 settimane e taper. Tra due sedute dure c'è sempre una corsa lenta (Z2/base) per non stressare le gambe; d'estate due sedute veloci corte e intense separate da Z2 (es. martedì interval, giovedì Z2, weekend qualità), niente lungo lento. Ogni seduta ha la data (giorno + mese). Il piano non compare all'apertura: si mostra con "Mostra ultimo piano" o rigenerando
